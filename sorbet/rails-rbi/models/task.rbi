...
# Please rerun rake rails_rbi:models[Task] to regenerate.
...
class Task::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { implementation.params(block: T.proc.params(e: Task).void).void }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[Task]) }
